...
export function formatForMatrix(text) {
 ...
 */
export function shouldSkipEvent(event, botUserId, connectedAt, joinedRooms, roomId) {
    // Ignore own messages
...
export function extractUsername(userId) {
 ...
 */
export function wasBotMentioned(messageText, botUserId) {
