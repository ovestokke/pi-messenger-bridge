        ...
        case "WhatsApp": {
            ...
            if (acquireLock()) {
                try {
                    ...
                    releaseLock();
                    mctx.ui.notify(`⚠️ WhatsApp setup error: ${err.message}`, "error");
                }
            }
            else {
        ...
        case "Slack": {
            ...
            if (acquireLock()) {
                try {
                    ...
                    releaseLock();
                    mctx.ui.notify(`⚠️ Slack setup error: ${err.message}`, "error");
                }
            }
            else {
        ...
        case "Discord": {
            ...
            if (acquireLock()) {
                try {
                    ...
                    releaseLock();
                    mctx.ui.notify(`⚠️ Discord setup error: ${err.message}`, "error");
                }
            }
            else {
